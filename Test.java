...
// Inheritence & Polymorphism Small Economy Food Service Industry Program - Test -
...
// - Test to check for the Restaurant -
	...
	public static int Restaurant_check01(Restaurant MamaAfrica, Owner Amara, Staff Sade,Server Nia) {
		...
		// - Test to check for the Restaurant Constructor test -
		// - Test to Check for the Restaurant's Fixed cost -
		...
		// - Test to check for the Restaurant's Owner -
		...
		// - Test to check for the Restaurant's Cook -
	...
	// - Test to check for the workShift getIncomeTaxPayers -
	...
	public static int Restaurant_check02(Restaurant MamaAfrica, Owner Amara, Staff Sade,Server Nia){
		...
		// - Test to check for the getIncomeTaxPayers -
	...
	public static int Restaurant_check03(Restaurant MamaAfrica, Owner Amara, Staff Sade,Server Nia){
		...
		// - Test to check for the Distribute income and sales tax -
	...
	public static int Fastfood_check01(){
		...
		// - Test to check for the constructor fields -
		...
		// - Test to check for the shallow copy -
		...
		// - Test to check for the Owner's Expense -
		...
		// - Test to check for the staff's income -
...
// - Test to check for the Income Tax -
		ann.workHours(8);
...
// - Test to check for the Customer -
...
// - Test to check for the Tax Collector -
